...
<div class="parallax-container">
			  ...
			  <div class="container">
			  	...
			  	<h2 class=" row center red-text"> <i class="medium material-icons prefix">warning</i> ERROR </h2>
			  	<p> </p>
			</div>

			<div class="container">
			  <div class="row center">
		<h2 class="red-text">Account Error</h2>
		

		<p>This mail, Last Name and First Name exist in Mind School or you haven't fill all the form.</p>
