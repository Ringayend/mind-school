			  ...
			  <div class="container">
				    <div class="section">
				      ...
				      <div class="row hide-on-small-only">
					    ...
					    <div class="card-content">
				            ...
				            <a href="/schools/MyProfil" class="waves-effect waves-light btn light-blue lighten-2">Access</a>
				        	</div>
					    </div>
					  </div>
				        ...
				        <div class="col s5  offset-s2 amber lighten-4 z-depth-5">
				          <div class="icon-block">
				            <h2 class="center black-text"><i class=" medium material-icons">school</i></h2>
				            <h5 class="center">Students</h5>

				            <p class="light center">Get acces to list of Students to create, update or delete a student profil.</p>
				            <div class="row center">
				    ...
				    <div class="container col s12 ">
				    	...
				    	<div class="card col s5 green lighten-4 z-depth-5">
				            ...
				            <p class="light center">Get acces to list of Teachers to create, update or delete a teacher profil.</p>
				            <div class="row center">
				            <a href="/teachers/index" class="waves-effect waves-light btn light-blue lighten-2">Access</a>
				        	</div>
					  </div>
